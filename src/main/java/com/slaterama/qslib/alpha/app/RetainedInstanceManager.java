...
public class RetainedInstanceManager implements Map<String, Object> {
	...
	/**
	 * Factory method used to create a RetainedInstanceManager using a {@link Activity}.
	 *
	 * @param activity The {@link Activity} used to create the RetainedInstanceManager.
	 * @return The newly-created RetainedInstanceManager.
	 */
	public static RetainedInstanceManager newInstance(Activity activity) {
		if (activity == null)
			throw new IllegalArgumentException("Activity can not be null");
		return new RetainedInstanceManager(activity.getFragmentManager());
	}
